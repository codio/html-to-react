...
var reactAttrsIndex = require('./react-specific-attributes').reactSpecificAttributes;
            ...
            forEach(node.attribs, function(value, key) {
                switch (key || '') {
                    ...
                    case 'class':
                        ...
                        break;
                    default:
                        var reactSpecificAttr = reactAttrsIndex[key.toLowerCase()];
                        if (reactSpecificAttr && reactSpecificAttr.hasBoolValue && value === '') {
                            value = true;
                        }
                        var reactSpecificAttrName = reactSpecificAttr && reactSpecificAttr.nameForReact;
                        elementProps[reactSpecificAttrName || key] = value;
                        break;
                }
            });
        }
